	...
	<section id="section-one">
        <div class="row d-block pl-phone">
            ...
            <div class="text-helper">
                <span class="ml-1 pt-5">Completa todos los campos del formulario para registrar un nuevo conductor.</span>
            </div>
        </div>
        <div class="row">
            <div class="col s12 center-align">
                <form action="../../controller/drivers/create/registerDriver.php" method="POST" class="col s10 m-auto f-none ml-2 ml-0-phone">
                    <div class="row">
                    ...
                    <div class="row mb-5-phone ">
                        <div class="float-r right-align d-flex-alter">
                            <a href="drivers.php" class="btn btn-actions btn-disabled">
                                Volver
                            </a>
